...
class Arguments:
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--hard_prune_ratio', type=int, help="the ratio of hard pruning", default=50)
        self.parser.add_argument('--method', type=str, help="the method of hard pruning", default='kernel', 
                                 choices=['kernel', 'ocgin'])
        self.parser.add_argument('--use_hard_prune', action='store_true', help="use hard pruning or not", default=True)
        self.parser.add_argument('--soft_prune_ratio', type=float, help="the ratio of pruning", default=0.5)
